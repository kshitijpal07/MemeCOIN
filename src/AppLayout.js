...
function AppLayout() {
  ...
  const handleMintMeme = async () => {
    if (!selectedImage || !nftName || !recipientAddress) {
    ...
    try {
        ...
        const metadataUrl = await uploadMetadataToPinata(imageUrl, nftName, nftDescription);
        
        // Set the tokenUri to the metadata URL
        setTokenUri(metadataUrl);
        
        toast.info('Minting NFT...');
        // Call your existing mintMeme function from nftService
        await mintMeme(recipientAddress, metadataUrl);
          ...
          <div>
            ...
            <Card className="mt-6">
              ...
              <div className="space-y-4">
                <div>
                  <label htmlFor="nftImage" className="block text-sm font-medium">NFT Image</label>
                  <Input
                    id="nftImage"
                    type="file"
                    accept="image/*"
              ...
              <div>
                <label htmlFor="nftName" className="block text-sm font-medium">NFT Name</label>
                <Input
                  id="nftName"
              ...
              <div>
                <label htmlFor="nftDescription" className="block text-sm font-medium">Description</label>
                <Input
                  id="nftDescription"
